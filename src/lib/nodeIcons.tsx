...
/**
 * The Flowe node icon set — pastel-neon strokes with a soft self-glow.
 * Single source of truth: used by the palette, the node cards, and the
 * config panel so every surface speaks the same visual language.
 */
