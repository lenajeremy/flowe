...
const OP_LABELS: Record<string, string> = { create_issue: 'Create Issue', get_issue: 'Get Issue', update_issue: 'Update Issue', list_issues: 'List Issues', search_issues: 'Search Issues', create_comment: 'Comment on Issue', create_pull_request: 'Create PR', merge_pull_request: 'Merge PR', list_pull_requests: 'List PRs', get_pull_request: 'Get PR', list_pr_files: 'List PR Files', list_commits: 'List Commits', list_branches: 'List Branches', get_repo_details: 'Repository Details', list_repo_tree: 'Repository Structure', get_file: 'Read File', create_or_update_file: 'Commit File', list_releases: 'List Releases', create_release: 'Create Release', trigger_workflow: 'Trigger Workflow', list_workflow_runs: 'List Workflow Runs', list_repos: 'List Repos' }
