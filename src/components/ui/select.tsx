...
// ── App-compat Select ───────────────────────────────────────────
// The config panels' original 4-prop select, rebuilt on the primitives
// above so existing call sites keep working with the shadcn popup UX.
// Sized for the config-panel scale (xs mono, full width).
