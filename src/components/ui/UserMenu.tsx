...
const THEME_OPTIONS: { value: ThemePref; label: string; icon: React.ReactNode }[] = [
  ...
  },
  {
    ...
    icon: (
      <svg width="12" height="12" viewBox="0 0 14 14" fill="none">
        <path d="M11.8 8.6A5.2 5.2 0 015.4 2.2a5.2 5.2 0 106.4 6.4z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
...
export function UserMenu() {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-[220px] bg-[var(--color-elevated)]">
        ...
        {/* Theme picker — interactive row, so not a menu item (no auto-close) */}
